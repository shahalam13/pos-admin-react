                        ...
                        <Row className="justify-content-center">
                            <Col md="8" lg="6" xl="5">
                                <Card className="overflow-hidden">
                                    <CardBody className="pt-0">
                                        ...
                                        <div className="p-3">
                                            ...
                                            <p className="text-muted text-center">Get your free Bronox account now.</p>
                                            ...
                                            <AvForm onValidSubmit={this.handleSubmit} className="form-horizontal mt-4">
                                                ...
                                                <div className="form-group mb-0 row">
                                                    <Col xs="12" className="mt-4">
                                                        <p className="text-muted mb-0 font-size-14">By registering you agree to the Bronox <Link to="#" className="text-primary">Terms of Use</Link></p>
                                                    </Col>
                                                </div>
                                            </AvForm>
                                        </div>
                                ...
                                <div className="mt-5 text-center">
                                    ...
                                    <p>© 2018 - 2020 Bronox. Crafted with <i className="mdi mdi-heart text-danger"></i> by Shah Alam</p>
                                </div>
                            </Col>
                        </Row>
                    </Container>
