...
class UiTypography extends Component {
    ...
    componentDidMount(){
        this.props.setBreadcrumbItems("Typography", this.state.breadcrumbItems);
    }
                        ...
                        <Col lg="6">
                            <Card>
                                <CardBody>
                                    ...
                                    <p className="card-title-desc">All HTML headings, <code className="highlighter-rouge">&lt;h1&gt;</code> through <code className="highlighter-rouge">&lt;h6&gt;</code>, are available.</p>
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <p className="card-title-desc">Remove the default <code className="highlighter-rouge">list-style</code> and left margin on list items (immediate children only). <strong>This only applies to immediate
                                            children list items</strong>, meaning you will need to add the className for any nested lists as well.</p>
                        ...
                        <Col lg="6">
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <p className="card-title-desc">For quoting blocks of content from another source within your document. Wrap <code className="highlighter-rouge">&lt;blockquote
                                            className="blockquote"&gt;</code> around any <abbr title="HyperText Markup Language">HTML</abbr> as the quote.</p>

                                    <blockquote className="blockquote font-size-16">
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <p className="card-title-desc">Remove a list’s bullets and apply some light <code className="highlighter-rouge">margin</code> with a combination of two classNamees, <code className="highlighter-rouge">.list-inline</code> and
                        ...
                        <Col xs="12">
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <p className="card-title-desc">Align terms and descriptions horizontally by using our grid system’s predefined classNamees (or semantic mixins). For longer terms, you can optionally add a <code className="highlighter-rouge">.text-truncate</code> className to truncate the text with an ellipsis.</p>
